        ...
        <>
            ...
            <main className='flex w-full flex-col items-center justify-center'>
                <Layout className='pt-16'>
                    <AnimatedText text={'The purpose of life is a purposeful life.'} className='mb-16 lg:!text-7xl sm:!text-6xl xs:!text-4xl sm:mb-8' />
                    <div className='grid w-full grid-cols-8 gap-6 sm:gap-8'>
                        ...
                        <div className='col-span-2 flex flex-col items-end justify-between xl:col-span-8 xl:flex-row xl:items-center md:order-3'>
                            ...
                            <div className='flex flex-col items-end justify-center xl:items-center'>
                                ...
                                <h2 className='text-xl font-medium capitalize text-dark/75 xl:text-center md:text-lg sm:text-base xs:text-sm'>worked companies</h2>
                            </div>
                        </div>
                    </div>
                    <Skills />
